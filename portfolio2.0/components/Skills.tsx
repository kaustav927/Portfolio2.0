  ...
  return (
    ...
    <div className="container mt-14 w-10/12 lg:w-8/12 lg:max-w-screen-lg flex flex-col items-begining py-4">
      ...
      <div className="flex flex-col">
        ...
        <h1 className="text-xl font-cd-semibold mt-8 dark:text-white">Frontend</h1>
          <div className="flex-wrap flex mt-2">
            {frontend.map((item, index) => (
              <span key={index} className="font-cd-semibold mb-3 text-white bg-slate-800 dark:text-black dark:bg-cool-white text-sm mr-3 px-3 py-2">{item}</span>
            ))}
          </div>

        <h1 className="text-xl font-cd-semibold mt-8 dark:text-white">Blockchain</h1>
        <div className="flex-wrap flex mt-2">
        ...
        <h1 className="text-xl font-cd-semibold mt-8 dark:text-white">Backend</h1>
        <div className="flex-wrap flex mt-2">
