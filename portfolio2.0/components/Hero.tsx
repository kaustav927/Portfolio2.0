...
function Hero() {
  return (
    <div className="container flex flex-col justify-between items-center mx-auto px-2 md:px-14 lg:px-24 w-full overflow-none">
      <div className="flex flex-wrap md:flex-nowrap">
            <div className="flex flex-wrap ml-5 lg:ml-20 justify-center md:justify-start max-w-xl mt-0 md:my-10">
            <div className="relative w-full max-w-lg">
            <h1 className="font-cd-regular  text-2xl my-10 md:text-6xl lg:text-7xl text-center md:text-left">Building beautiful web experiences.</h1>
