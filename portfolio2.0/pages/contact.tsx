          ...
          <div className="container mt-1 flex flex-col justify-center items-center h-full px overflow-hidden dark:text-white">
            <div className="flex flex-col md:flex-row lg:flex-row mt-4 w-full h-1/2">
              <div className="md:w-2/3 lg:w-2/3 w-full items-center justify-center mb-8 lg:mb-12 lg:">
                <h1 className="text-lg md:text-xl lg:text-3xl font-cd-bold text-left mb-8">
                ...
                <p className="text-md font-cd-medium text-left mb-6">
                  Open to client projects, offers, or open-source collaboration.{" "}
                </p>
                <p className="text-sm font-cd-medium text-left mb-6">
                  Available 24/7 for artists, creative agencies and startups
                  from anywhere.{" "}
                </p>
              </div>
              ...
              <div className="md:w-1/2 lg:w-1/2 w-full ml-0 lg:ml-8 md:ml-8">
                <div className="flex flex-col items-center">
                  <div className="flex flex-col items-center justify-center">
                    <div className="mb-4">
                      <h1 className="font-cd-medium text-sm ml-2 text-center">
                        Time Zone:{" "}
                      </h1>
                      <h2 className="font-cd-regular text-sm ml-2 text-center">
                        <span className="font-cd-medium mr-2">EST, </span>{" "}
                        UTC-5:00, GMT-4:00
                      </h2>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center">
                    <div className="mb-4">
                      ...
                      <h2 className="font-cd-medium text-sm ml-2 text-center">
                        ksharm27@outlook.com
                      </h2>
                    </div>
                  </div>
            ...
            <div className=" mt-4 h-1/2 flex items-center justify-center">
              <h1 className="text-md md:text-xl lg:text-4xl underline py-40 font-cd-bold text-justify ">
                ksharm27@outlook.com
              </h1>
            </div>
          </div>
